...
class Order {
  ...
  final String status;
  final String?
      stage; // NEW: Pending, In Progress, Ready for Fitting, Ready, Collected
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'fabric_image_path': fabricImagePath,
  ...
  factory Order.fromMap(Map<String, dynamic> map) {
    return Order(
      ...
      fabricImagePath: map['fabric_image_path'] as String?,
      styleImagePath: map['style_image_path'] as String?,
  ...
  Order copyWith({
    ...
    return Order(
      ...
      fabricImagePath: fabricImagePath ?? this.fabricImagePath,
      styleImagePath: styleImagePath ?? this.styleImagePath,
