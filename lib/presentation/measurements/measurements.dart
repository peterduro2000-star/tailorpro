...
class _MeasurementsState extends State<Measurements> {
  ...
  final TextEditingController _maleShirtLengthController =
      TextEditingController();
  final TextEditingController _maleTrouserLengthController =
      TextEditingController();
  ...
  final TextEditingController _femaleShoulderController =
      TextEditingController();
  final TextEditingController _femaleNeckController = TextEditingController();
  final TextEditingController _femaleDressLengthController =
      TextEditingController();
  final TextEditingController _femaleSkirtLengthController =
      TextEditingController();
  final TextEditingController _femaleSleeveController = TextEditingController();
  final TextEditingController _femaleArmholeController =
      TextEditingController();
  final TextEditingController _femaleUnderBustController =
      TextEditingController();
  ...
  Future<void> _loadMeasurementHistory(int customerId) async {
    try {
      ...
      setState(() {
        _measurementHistory =
            measurements.map((m) => m.toDisplayMap()).toList();
      });
    } catch (e) {
  ...
  void _copyMeasurements(Map<String, dynamic> history) {
    setState(() {
      ...
      if (_selectedGender == 'Male') {
        ...
        _maleShirtLengthController.text =
            values['Shirt Length']?.toString() ?? '';
        _maleTrouserLengthController.text =
            values['Trouser Length']?.toString() ?? '';
        ...
        _femaleDressLengthController.text =
            values['Dress Length']?.toString() ?? '';
        _femaleSkirtLengthController.text =
            values['Skirt Length']?.toString() ?? '';
        _femaleSleeveController.text =
            values['Sleeve Length']?.toString() ?? '';
        _femaleArmholeController.text = values['Armhole']?.toString() ?? '';
        _femaleUnderBustController.text =
            values['Under Bust']?.toString() ?? '';
      }
    });
    ...
    try {
      ...
      if (_selectedGender == 'Male') {
        ...
        if (_maleShoulderController.text.isNotEmpty) {
          measurementValues['Shoulder'] =
              double.parse(_maleShoulderController.text);
        }
        ...
        if (_maleShirtLengthController.text.isNotEmpty) {
          measurementValues['Shirt Length'] =
              double.parse(_maleShirtLengthController.text);
        }
        if (_maleTrouserLengthController.text.isNotEmpty) {
          measurementValues['Trouser Length'] =
              double.parse(_maleTrouserLengthController.text);
        }
        if (_maleSleeveController.text.isNotEmpty) {
          measurementValues['Sleeve Length'] =
              double.parse(_maleSleeveController.text);
        }
        if (_maleArmholeController.text.isNotEmpty) {
          measurementValues['Armhole'] =
              double.parse(_maleArmholeController.text);
        }
        ...
        if (_femaleWaistController.text.isNotEmpty) {
          measurementValues['Waist'] =
              double.parse(_femaleWaistController.text);
        }
        ...
        if (_femaleShoulderController.text.isNotEmpty) {
          measurementValues['Shoulder'] =
              double.parse(_femaleShoulderController.text);
        }
        ...
        if (_femaleDressLengthController.text.isNotEmpty) {
          measurementValues['Dress Length'] =
              double.parse(_femaleDressLengthController.text);
        }
        if (_femaleSkirtLengthController.text.isNotEmpty) {
          measurementValues['Skirt Length'] =
              double.parse(_femaleSkirtLengthController.text);
        }
        if (_femaleSleeveController.text.isNotEmpty) {
          measurementValues['Sleeve Length'] =
              double.parse(_femaleSleeveController.text);
        }
        if (_femaleArmholeController.text.isNotEmpty) {
          measurementValues['Armhole'] =
              double.parse(_femaleArmholeController.text);
        }
        if (_femaleUnderBustController.text.isNotEmpty) {
          measurementValues['Under Bust'] =
              double.parse(_femaleUnderBustController.text);
        }
      }
      ...
      if (authProvider.isAuthenticated) {
        try {
          await authProvider.cloudSync.saveMeasurementToCloud(
            savedMeasurement,
            authProvider.currentUserId!,
          );
        } catch (e) {
          debugPrint('WARNING: Measurement cloud sync failed: $e');
        }
      }
