...
class OrderSummaryWidget extends StatelessWidget {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 0.5.h),
                Text(
                  customer["phone"] as String? ?? 'No phone number',
                  style: theme.textTheme.bodySmall?.copyWith(
                    color: theme.colorScheme.onSurfaceVariant,
                  ),
                ),
  ...
  Widget _buildMeasurementCard(ThemeData theme) {
    final measurements =
        (measurement["measurements"] as Map<String, dynamic>?) ?? {};
    ...
    return _buildEditableCard(
      ...
      child: Column(
        ...
        children: [
          Text(
            measurement["name"] as String? ?? 'Saved Measurements',
  ...
  Widget _buildFabricCard(ThemeData theme) {
    ...
    final semanticLabel =
        fabric["semanticLabel"] as String? ?? 'Selected fabric preview';
        ...
        children: [
          ClipRRect(
            ...
            child: imageUrl != null
                ...
                : _buildImageFallback(theme, Icons.texture, 20.w, 20.w),
          ),
          SizedBox(width: 3.w),
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  fabric["name"] as String? ?? 'Selected Fabric',
                  style: theme.textTheme.titleSmall?.copyWith(
                    fontWeight: FontWeight.w600,
                  ),
                ),
                SizedBox(height: 0.5.h),
                Text(
                  fabric["color"] as String? ?? 'Color not specified',
                  style: theme.textTheme.bodySmall?.copyWith(
                    color: theme.colorScheme.onSurfaceVariant,
                  ),
                ),
                SizedBox(height: 0.5.h),
                Text(
                  fabric["quantity"] as String? ?? 'Quantity not specified',
                  style: theme.textTheme.labelSmall?.copyWith(
                    color: theme.colorScheme.onSurfaceVariant,
                  ),
                ),
  ...
  Widget _buildStyleCard(ThemeData theme) {
    final imageUrl = style["image"] as String?;
    final semanticLabel =
        style["semanticLabel"] as String? ?? 'Selected style preview';
        ...
        children: [
          ClipRRect(
            ...
            child: imageUrl != null
                ...
                : _buildImageFallback(theme, Icons.checkroom, 20.w, 20.w),
          ),
          SizedBox(width: 3.w),
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  style["name"] as String? ?? 'Selected Style',
                  style: theme.textTheme.titleSmall?.copyWith(
                    fontWeight: FontWeight.w600,
                  ),
                ),
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Text(
                        style["category"] as String? ?? 'Category',
                        style: theme.textTheme.labelSmall?.copyWith(
                          color: theme.colorScheme.primary,
                        ),
                      ),
