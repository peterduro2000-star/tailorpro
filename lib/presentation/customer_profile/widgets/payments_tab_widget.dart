...
class _PaymentsTabWidgetState extends State<PaymentsTabWidget> {
  ...
  Future<void> _loadPayments() async {
    try {
      ...
      await _paymentRepository.createMissingPaymentRecordsForPaidOrders(
        customerId,
      );
      final payments = await _paymentRepository.getCustomerPayments(customerId);
      final orders = await _orderRepository.getCustomerOrders(customerId);

      final totalPaid =
          await _paymentRepository.getCustomerTotalPaid(customerId);
      final totalOrders =
